...
export default function CreateListing() {
    ...
    const [loading, setLoading] = useState(false); console.log(formData);
    //console.log(files);
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <button
                            ...
                            className='p-3 text-green-600 border border-green-700 rounded '>
                    ...
                    {formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
                        ...
                        >
                            <img
                                src={url}
                                alt='listing image'
                                className='w-20 h-20 object-contain rounded-lg cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-110'
                            />
                            <button
                                type='button'
                    ...
                    <button
                        className='uppercase border border-blue-700 bg-blue-700 rounded text-white hover:bg-blue-600  p-3'>
                        Create Listing
                    </button>
                </div>
            </form>
