      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          <Link to={'/About'} className='font-semibold hover:underline'>
            <span className='text-black'>TO.</span><span className='text-green-700'>Estate</span></Link> is the best place
        ...
        <Link
          to={'/search'}
          className='text-xs sm:text-sm w-fit text-green-700 font-bold hover:underline'
        >
          Let's get started...
        </Link>
      </div>
